class Fansite < ApplicationRecord
  ...
  belongs_to :user#, :counter_cache => :fansites_count

  # Post와 Comment의 1:N 관계
  has_many :fansite_comments, dependent: :destroy

  # Post와 hashtag의 N:N 관계
  # 이렇게 해도 posts_tags라는 Join 테이블이 자동으로 생성됨
  #has_and_belongs_to_many :fansite_tags
