  ...
  module ViewHelpers
    ...
    protected
      ...
      def previous_page_set
        page_set = (@options[:page_set] || @options[:inner_window]).to_i
        num = @collection.current_page > 1 && @collection.current_page - page_set
        previous_or_next_page(num, @options[:previous_label], 'previous_page')
      end      
      ...
      def next_page_set
        page_set = (@options[:page_set] || @options[:inner_window]).to_i
        num = @collection.current_page < total_pages && @collection.current_page + page_set
        previous_or_next_page(num, @options[:next_label], 'next_page')
      end
