...
jQuery(function(){
    ...
    jQuery.validator.setDefaults({
        ...
        errorPlacement: function (a, b) {
			...
			else if(b.hasClass('data-error-place-parent')) b.parent().parent().append(a);
			else if(b.hasClass('data-error-place-parent2')) b.parent().parent().parent().append(a);
...
(function() {
  window["cama_init_media"] = function(media_panel) {
    ...
    show_file = function(item) {
      ...
      tpl = "<div class='p_thumb'></div>" + "<div class='p_label'><b>" + I18n("button.name") + ": </b><br> <span>" + data["name"] + "</span></div>" + "<div class='p_body'>" + "<div style='overflow: auto;'><b>" + I18n("button.url") + ":</b><br> <a target='_blank' href='" + data["url"] + "'>" + data["url"] + "</a></div>" + "<div><b>" + I18n("button.size") + ":</b> <span>" + cama_humanFileSize(parseFloat(data["file_size"])) + "</span></div>" + "</div>";
